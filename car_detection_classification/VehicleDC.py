...
def car_detect(input_path):
    ...
    DR_model = Car_DC(src_dir=input_path, dst_dir='./')
    DR_model.detect_classify()

# D:\DDDDDDDDDDDDDDDDDDDOWNLOAD\PyQt_cam\img_save_path\image20200125193712.jpg
car_detect('./test_imgs/test_0.jpg')
# car_detect('D:/DDDDDDDDDDDDDDDDDDDOWNLOAD/PyQt_cam/img_save_path/image20200125193712.jpg')